...
const PHRASES = [
  "Build an agent to swap SOL to USDC on Jupiter",
  "Mint a compressed NFT when a tweet is posted",
  "Track devnet wallet balance and request a faucet",
  "Create a portfolio tracker that monitors token prices",
  "Launch a Telegram bot that executes Solana trades",
];
    ...
    >
      ...
      <div
        style={{
          ...
          borderRadius: 12,
          background:
            "linear-gradient(var(--send-btn-angle, 180deg), #ff3700 0%, #ffae00 100%)",
          animation: "send-btn-bg-rotate 4s linear infinite",
          boxShadow:
            "inset 0 1px 18px 2px rgba(255,55,0,0.25), inset 0 1px 4px 2px rgba(255,255,255,0.80), 0 42px 107px 0 rgba(255,55,0,0.35), 0 10px 10px 0 rgba(255,55,0,0.20), 0 3.714px 4.846px 0 rgba(255,55,0,0.15)",
          display: "flex",
          alignItems: "center",
          justifyContent: "center",
          overflow: "hidden",
      ...
      >
        <div
          style={{
            ...
            pointerEvents: "none",
            background:
              "conic-gradient(from 0deg, rgba(255,255,255,0) 0deg, #FFFFFF 60deg, #FFF7C0 120deg, rgba(255,255,255,0) 200deg, rgba(255,255,255,0) 360deg)",
            WebkitMask:
    ...
    >
      <div
        style={{
          ...
          height: 160,
          background:
            "linear-gradient(180.9deg, rgba(255, 55, 0, 0.08) -0.58%, rgba(20, 20, 22, 0.75) 66.34%, rgba(10, 10, 11, 0.75) 101.25%), rgba(15, 15, 15, 0.85)",
          boxShadow:
            ...
            >
              <div
                style={{
                  ...
                  borderRadius: 4,
                  background:
                    "linear-gradient(166deg, #ff3700 9.8%, #ffae00 184.41%)",
                  display: "flex",
                  alignItems: "center",
                  justifyContent: "center",
                }}
